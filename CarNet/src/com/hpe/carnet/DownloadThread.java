...
public class DownloadThread extends Thread {
	...
	//private BackgroundTrafficTask backgroundtask;
	DownloadThread(String downfile,String pcapfile, String ip, int port)
	{
    ...
    public void run() {
    	...
    	try {
   	     ...
   	     download(downloadFile,pcapname, socket);
   	     socket.close();
        ...
        try {
           ...
           // Log.d("==","fileLength: " + fileLength + " B");
            ...
            //	Log.d("==","downing to ..."+localFile);
            	...
            	Log.e(Common.TAG,"download " + downloadFile + " error! ");
